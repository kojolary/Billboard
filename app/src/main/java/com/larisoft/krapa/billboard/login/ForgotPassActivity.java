...
import com.larisoft.krapa.billboard.utils.CheckNetwork;
import com.larisoft.krapa.billboard.utils.Constants;
import com.larisoft.krapa.billboard.utils.ValidateUserInfo;
...
public class ForgotPassActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txt_remembered = findViewById(R.id.txt_remembered);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.txt_remembered:
                startActivity(new Intent(ForgotPassActivity.this, login.class));
                finish();
                break;
        }
    }
