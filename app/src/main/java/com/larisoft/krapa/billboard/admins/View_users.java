package com.larisoft.krapa.billboard.admins;
...
import com.larisoft.krapa.billboard.mListView.ProductAdapter;
...
public class View_users extends AppCompatActivity
    ...
    String URL = "https://app.tedxafariwaa.com/LoginandRegistration/users.php";
...
// Creating Progress dialog.
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        productList.add(new Product(
                                ...
                                product.getString("user_level"),
                                product.getString("assembly")
                        ));
                    }

                    //creating adapter object and setting it to recyclerview
                    ProductAdapter adapter = new ProductAdapter(getApplication(), productList);
                    Toast.makeText(getApplication(),
                            "Oops. Timeout error!" + adapter,
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_add_user) {
            Intent a = new Intent(View_users.this, Add_user.class);
            startActivity(a);

        } else if (id == R.id.nav_view_user) {
            Intent v = new Intent(View_users.this, View_users.class);
            startActivity(v);
        } else if (id == R.id.nav_view_billboard) {
            Intent v = new Intent(View_users.this, View_billboards.class);
            startActivity(v);
